...
However, even after 100 iterations of Newton's algorithm, the iterative step does not close in on zero, which leads to the conclusion that the data points in the given set are \textbf{not linearly separable}.
