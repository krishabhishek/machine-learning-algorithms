...
\label{sec:methodology}
    ...
    The research questions listed in Section~\ref{sec:research_questions} will be tackled by surveying a few of the important overview papers\cite{goldberg2016primer}\cite{bengio2003neural}\cite{morin2005hierarchical}. A few of the groundbreaking research papers in this area will also be studied, including Word2Vec\cite{mikolov2013efficient}\cite{mikolov2013distributed}\cite{mikolov2013linguistic}.

    In addition to this the other application areas include tasks like part-of-speech tagging, chunking, named entity recognition, and semantic role labeling\cite{socher2011parsing}\cite{luong2013better}\cite{maas2015lexicon}\cite{li2015hierarchical}\cite{collobert2011natural}.
