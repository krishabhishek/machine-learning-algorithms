...
PYTHONPATH=$PROJECT_DIRECTORY /usr/bin/python $PROJECT_DIRECTORY/gp_linear_regression_runner.py --input_data_folder $PROJECT_DIRECTORY/data/ --kernel_type GaussianKernel --gaussian_variance 6 --metrics_file $OUTPUT_FOLDER/results_gaussian_process_reg_gaussian.json
